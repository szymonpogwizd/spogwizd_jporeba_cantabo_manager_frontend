...
export default function SwitchShowTitle({ onSwitchChange, expandedListValue }) {
  const [isChecked, setIsChecked] = useState(expandedListValue);

  useEffect(() => {
    setIsChecked(expandedListValue);
  }, [expandedListValue]);
